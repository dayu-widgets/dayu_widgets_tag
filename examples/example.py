...
from dayu_widgets_tag import MTag, MCheckableTag, MNewTag
...
class MTagTest(QWidget):
    def __init__(self, parent=None):
        ...
        self.default_lay.addWidget(MTag('Tag 1'))
        self.default_lay.addWidget(MTag('Clickable Tag').clickable())
        self.default_lay.addWidget(MTag('Closeable Tag').closeable())
        ...
        for text, color in [('red', dayu_theme.red),
            ...
            tag = MTag(text=text).no_border().clickable()
            tag.set_dayu_color(color)
